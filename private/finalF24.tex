...
Recall that a function is \emph{total} if it is defined for all legal inputs; otherwise, it is \emph{partial}. Thus a function with no precondition (weakest precondition) is total.  We can often turn a partial function into a total function in two steps. 
\begin{enumerate}
