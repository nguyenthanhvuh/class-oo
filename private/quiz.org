...
** Verification using Hoare Logic
   ...
   2. Now, consider the given P2.  Recompute the VC of the program with respect to P2 and reason about the VC (e.g., does P1 -> WP ? if yes, what does that mean,  if not, what does that mean)
