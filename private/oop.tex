...
\subsubsection{In-Class Exercise: Checking Rep-Invs}
...
Consider the mutable \code{Queue} implementation in \autoref{ex:mutable-queue}. Rewrite \code{Queue} to be \emph{immutable}. Keep the representation variables \code{elements} and \code{size}.
