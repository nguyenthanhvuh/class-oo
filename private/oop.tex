...
\paragraph{Comparable interface} A good example of an interface is the \code{Comparable} interface, which defines a single method \code{compare\_to} that allows objects to be compared to each other. Any class that implements the \code{Comparable} interface can be compared to other objects of the same type, enabling sorting and other operations that require comparison.
