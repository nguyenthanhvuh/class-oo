...
\item Note that in Python or Java, immutable types include \code{int}, \code{float}, \code{str}, \code{tuple}, and \code{frozenset}. and mutable types include \code{list}, \code{dict}, and \code{set}.
\end{enumerate}
