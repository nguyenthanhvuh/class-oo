...
class BankAccount:
    def __init__(self, balance: float):
        self._balance = balance if balance >= 0 else 0  # Balance must be non-negative
    ...
    def get_balance(self) -> float:
        # Postcondition: returns the current balance, which is always non-negative
...
class SecureBankAccount(BankAccount):
    ...
    def deposit(self, amount: float) -> str:
        # Stronger postcondition: do the deposit and also add bonus interest
