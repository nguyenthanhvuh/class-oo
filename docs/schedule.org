...
* Schedule
  ...
  |       3 | Data Abstraction; Mutability              | Liskov 5.1--5.4, [[file:LiskovSet.java]], Poly.java |   [[#a2][A2 Due]]; [[#g2][Guide 2]]   |          IC 2 [[#ic2A][A]] [[#ic2B][B]]          |
...
** Guide 2
   ...
   Quiz 2 will focus on Liskov, Chapters 2-4 and Bloch 10. You should also be able to analyze and rewrite preconditions and postconditions for stand-alone procedures. The quiz will be closely modeled on the in-class exercises.
