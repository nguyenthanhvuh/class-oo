...
- [[./notes.ipynb][notes.ipynb]]: Python notebook format, you can download the file and load in VS Code or some other editor/viewer.
...
* Schedule
  ...
  |                                            | <l>                           |      <c>      |        <c>        |
  |--------------------------------------------+-------------------------------+---------------+-------------------|
  | +Class Overview+                           | Liskov 1--2                   |               |       IC [[#ic1][1]]        |
  | +Procedural Abstraction; Exceptions+       | Liskov 3--4, Bloch 10         |    [[#a1][A1 Due]]     |     IC 2 [[#ic2A][A]] [[#ic2B][B]]      |
  | +Imperative Program Verification+          | [[https://github.com/dynaroars/dynaroars.github.io/wiki/notes-hoare-logic][Hoare logic notes]]             |    [[#a2][A2 Due]]     |                   |
  | +Imperative Program verification+          | [[https://github.com/dynaroars/dynaroars.github.io/wiki/notes-hoare-logic][Hoare logic notes]]             | NO ASSIGNMENT |       IC [[#ic4][4]]        |
  | +Data Abstraction; Mutability+             | Liskov 5.1--5.10,             |    [[#a4][A4 Due]]     |     IC 5 [[#ic5A][A]] [[#ic5B][B]]      |
  | +Iteration Abstraction; Method Guidelines+ | Liskov 6, Bloch 8             |    [[#a5][A5 Due]]     |     IC 7 [[#ic7A][A]] [[#ic7B][B]]      |
  | +Type Abstraction+                         | Liskov 7                      |    [[#a6][A6 Due]]     |    IC 8 [[#ic8A][A]] [[#ic8B][B]] [[#ic8C][C]]     |
  | +Research Talk+ (slides: [[./files/swe619-dig.pdf][DIG]], [[./files/swe619-neuralsat.pdf][NeuralSAT]])   | /No New Material/             | NO ASSIGNMENT |       IC [[#ic9][9]]        |
  | +Polymorphic Abstract; Lambdas+            | Liskov 8, Bloch 7 (Item 42)   |    [[#a8][A8 Due]]     |       IC [[#ic10][10]]       |
  | +Generics+                                 | Bloch 5                       |    [[#a9][A9 Due]]     |    IC 11 [[#ic11A][A]] [[#ic11B][B]] [[#ic11C][C]]    |
  | +Common Java Contracts+                    | Bloch 3                       |    [[#a10][A10 Due]]    |     IC 12 [[#ic12A][A]] [[#ic12B][B]]     |
  | +Classes and Inheritance+                  | Bloch 4                       |    [[#a11][A11 Due]]    |    IC 13 [[#ic13A][A]] [[#ic13B][B]] [[#ic13C][C]]    |
  | +Contract Model in Testing+                | Advanced JUnit ([[./files/Ch03-automation.pptx ][slides 22-24)]] |    [[#a12][A12 Due]]    |       IC [[#ic14][14]]       |
  | Final Exam                                 | [[#ic16][example]] (sols in [[./notes.ipynb][Notes]])       |               |                   |
...
** In class 16
   ...
   1. What is the problem with =pushAll()= ?  write a contract for it.  What would Bloch suggest as an alternative?
...
*** Goals: Favoring composition over inheritance. Bloch, Item 18.
    ...
    Consider the ~InstrumentedSet~ example from Bloch Item 18 (as well as in-class exercise [[#ic13A][in-class 13A]]).
