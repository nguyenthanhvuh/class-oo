...
public class Poly {
    ...
    // largest exp with a non-zero coeff associated
    public int degree() {
       return deg;
    }
    ...
    public int coeff(int d) {
        ...
        // orig code:  if (d < 0 || d > deg) return 0; else return trm[d];
        // WHAT's WRONG WITH IT?
        // but this is different than the constructor, which returns IAE
    ...
    // Effects: If q is null throw NullPointerException
    // else return the Poly this + q (PRODUCER: return a new Poly)
