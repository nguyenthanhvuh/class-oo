...
\begin{document}
\begin{center}
{\Large \textsc{SWE-619 (Spring '25): OO Software Specification and Construction}}
\end{center}
\begin{center}
...
\begin{tabular}{llcccll}
  \toprule
  \textbf{Meetings:} & Wed 4:30PM -- 7:10PM  & & & & \textbf{Place: TBD} & \href{https://piazza.com/gmu/spring2025/swe619nguyen}{Piazza} (code \textbf{TBD})\\
...
\textbf{Office Hr:} & Mon 2:00PM -- 3:00PM & & & & \textbf{Place:} & ENGR 4430\\
                     &(email first)&&&&&\\
  \hline
\textbf{GTA:} & TBD & & &  & \textbf{Email:} &  \href{mailto:tbd@gmu.edu}{tbd@gmu.edu}\\
...
\item Concurrent Programming: Use multithreads, locks, and synchronization concepts for parallel computing.
\end{itemize}
