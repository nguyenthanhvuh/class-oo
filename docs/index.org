...
* General Information
  - Instructor: [[https://nguyenthanhvuh.github.io][ThanhVu Nguyen]]
    - Office Hrs: Mondays 2:00PM - 3:00PM (use class Zoom link below)
...
*** Weekly Quizzes
    ...
    - Each quiz happens during the last 15 minutes of class.
...
*** Final Exam
    ...
    There will be an online final exam at the time specified by the university's final exam schedule.
    -----
