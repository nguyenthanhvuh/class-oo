...
* Schedule
  ...
  |      13 | Final Exam ([[https://registrar.gmu.edu/wp-content/uploads/Fall-2022-Final-Exam-Schedule.pdf][GMU Final Exam Schedule]])     | [[#ic15][example]]                       |            |                   |   |
...
** In class 5B
   ...
   1. Analyze these 4 questions for rep-inv 1.
      1. Does =join()= maintain rep-inv?   YES
      1. Does =join()= satisfy contract?   YES
      1. Does =leave()= maintain rep-inv?  YES
      1. Does =leave()= satisfy contract?  NO
   1. Repeat for rep-inv 2.
      1. Does =join()= maintain rep-inv?  NO 
      1. Does =join()= satisfy contract?  YES  (but does not matter because already violate rep-inv)
      1. Does =leave()= maintain rep-inv?  YES 
      1. Does =leave()= satisfy contract? YES 
...
** In class 11A
   ...
   #+begin_src java
     ...
     public class ColorPoint extends Point {  // Second attempt: DON'T DO THIS!
         ...
         ...
             @Override public boolean equals(Object obj) {
             if (!(obj instance of Point)) return false;
   ...
   1. What is the =equals()= contract? How do you implement equal in this example?
      ...
      return super.equals(obj) && cp.color == color;
      #+end_comment
   1. Why is the =instanceof= operator used?
      #+begin_comment
   ...
   #+begin_src java
      ...
      public class IntSet implements Cloneable {
          ...
          public int hashCode() {
              ...
              //return 22;
              //return product(hashCode(fields)); //does work !
              result = hash(v1);
...
#+begin_comment
   ...
   - contents of elements are not null: INCORRECT (NOT a Repr Inv)
     size = 2 
     ["cat", "dog", null, "cow"]
